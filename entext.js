...
const basics={
    ...
    howlong:"How long did it take to complete the assessment (hours)",
    ...
    region:"Province where your organizations works",
    level:"Level where this program or project operates",
    save:"Save data",
    stage:"Stage of work",
    ...
    base:"Are you based in an urban or rural community?",
...
const levels=["Neighbourhood","City","Region","Town"];

const stages=["Emerging","Launching our initiative","Forming our plan","Implementing our plan","Sustaining our initiative"];
